...
parser.add_argument('--cab',   action='store_true', help='Enable CAB mechanism')
parser.add_argument('--seed', 			 type=int, default=1, help='Random seed for reproducible experiment (default: 1)')
parser.add_argument('--k', 			     type=int, default=5, help='Number of folds (default: 5)')
parser.add_argument('--k_start',		 type=int, default=-1, help='Start fold (Default: -1, last fold)')
parser.add_argument('--k_end',			 type=int, default=-1, help='End fold (Default: -1, first fold)')
parser.add_argument('--results_dir',     type=str, default='/work/ai4bio2024/brca_surv/survival/MCAT/results', help='Results directory (Default: ./results)')
...
if 'survival' in args.task:
	...
	dataset = Generic_MIL_Survival_Dataset(csv_path = "/work/ai4bio2024/brca_surv/survival/MCAT/datasets_csv_sig/filtered/my_tcga_brca_all_clean.csv.zip",
...
if args.cab:
	args.results_dir = os.path.join(args.results_dir, args.which_splits+"/cab/", args.param_code, str(args.exp_code) + '_s{}'.format(args.seed))
else:
	args.results_dir = os.path.join(args.results_dir, args.which_splits+"/all/", args.param_code, str(args.exp_code) + '_s{}'.format(args.seed))
if not os.path.isdir(args.results_dir):
...
args.split_dir = os.path.join('/work/ai4bio2024/brca_surv/survival/MCAT/splits', args.which_splits, args.split_dir)
