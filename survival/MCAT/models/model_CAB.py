...
class Reconstruction_Net(nn.Module):
    ...
    def forward(self, **kwargs):
        ...
        reconstruct, _ = self.cross_attention0(self.ln_1(self.tokens), self.ln_2(h_path_bag)) #MH
        reconstruct = self.ffn0(self.ln_3(reconstruct)) + reconstruct

        reconstruct, sim = self.cross_attention0(self.ln_4(self.tokens + reconstruct), self.ln_2(h_path_bag)) #MH
