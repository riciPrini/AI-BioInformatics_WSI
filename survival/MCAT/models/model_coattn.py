...
class MCAT_Surv(nn.Module):
    def __init__(self, fusion='concat', cab = False, omic_sizes=[100, 200, 300, 400, 500, 600], n_classes=4,
        ...
        ### For Reconstruction 
        self.recon_net = Reconstruction_Net(omic_sizes=omic_sizes, num_tokens=6)
...
# 
    def forward(self, **kwargs):
        ...
        if self.cab:
            ...
            h_omic = [self.sig_networks[idx].forward(sig_feat) for idx, sig_feat in enumerate(re_omics)] ### each omic signature goes through it's own FC layer
