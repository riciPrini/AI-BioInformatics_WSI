...
parser.add_argument('--results_dir',     type=str, default='/homes/rprini/MCAT_custom/results', help='Results directory (Default: ./results)')
...
if 'survival' in args.task:
	...
	dataset = Generic_MIL_Survival_Dataset(csv_path = "/homes/rprini/MCAT/datasets_csv_sig/filtered/my_tcga_brca_all_clean.csv.zip",
...
args.split_dir = os.path.join('/homes/rprini/MCAT/splits', args.which_splits, args.split_dir)
