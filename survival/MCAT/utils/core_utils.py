...
def train(datasets: tuple, cur: int, args: Namespace):
    ...
    if args.model_type =='snn':
        ...
        model_dict = {'fusion': args.fusion, 'cab': args.cab, 'omic_sizes': args.omic_sizes, 'n_classes': args.n_classes}
    ...
    print('Done!')
    # print_network(model) # remove this
    ...
    if args.early_stopping:
        early_stopping = EarlyStopping(warmup=0, patience=5, stop_epoch=5, verbose = True)
    else:
        early_stopping = None
